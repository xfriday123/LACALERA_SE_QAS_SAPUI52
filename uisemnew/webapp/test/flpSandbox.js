		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App uisemnew",
									"targetURL": "#nsnewuisemnew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsnewuisemnew-display": {
								"semanticObject": "nsnewuisemnew",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsnew.uisemnew",
									"url": sap.ui.require.toUrl("nsnew/uisemnew")
								}
							}
						}
					}
